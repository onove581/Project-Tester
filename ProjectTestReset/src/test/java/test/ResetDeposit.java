...
public class ResetDeposit {
    ...
    public void resetdeposit(String Account,String Amount,String Descrip){
        ...
        driver.findElement(By.name(AmountDepositForm.reset_button)).click(); //Login  button
