...
public class ResetNewCustomer {
    ...
    @Test(dataProvider = "resetnewcustomer" )
    public void resetnewcustomer(String name,String radio,String date,String address,String city,String state,String pin,String mobi,String email,String password){
        ...
        driver.findElement(By.name(modelnewcustomer.reset)).click(); //Login  button
    ...
    @DataProvider(name="resetnewcustomer")
